...
export default function Projects() {
  ...
  function clickOrHover(){
    const isDesktop = window.mobilecheck();
    if(isDesktop){
      return '(hover for more info)'
    }
    else {
        ...
        <div className="row project-row h-100 align-items-start justify-content-between">
          <div className="col-md-4 h-fit-content">
            <div className="d-flex card flex-column align-items-center memory-match">
              ...
              <div className="card-body pt-1 pr-1">
                <p className="card-text project-description"><b>Wildflower Match</b> is a memory matching game. The images used are hand drawn illistrations of wildflowers. {clickOrHover()}</p>
                <p className="card-text m-0 card-back"><b>Made Using: </b></p>
                <p className="card-text m-0 card-back mb-2">JavaScript JQuery HTML CSS</p>
          ...
          <div className="col-md-4 h-fit-content">
            <div className="d-flex project-card card flex-column align-items-center">
              ...
              <div className="card-body pt-1 pl-3 pr-1">
                <p className="card-text project-description"><b>Bujo Central</b> is a full-stack e-commerce application where the user can shop for bullet journalling supplies. {clickOrHover()}</p>
                <p className="card-text m-0 card-back"><b>Made Using:</b></p>
                <p className="card-text m-0 card-back mb-2">React.js Bootstrap Node.js PostgreSQL</p>
          ...
          <div className="col-md-4 h-fit-content">
            <div className="d-flex project-card card flex-column align-items-center">
              ...
              <div className="card-body pt-1 pl-3 pr-1">
                <p className="card-text project-description"><b>Habit Tracker</b> is a full-stack application for users to track their habits or send list of habits, called routines, to other users. {clickOrHover()}</p>
                <p className="card-text m-0 card-back"><b>Made Using:</b></p>
                <p className="card-text m-0 card-back mb-2">React.js Bootstrap Node.js PostgreSQL</p>
                <div className="card-back">
